...
curl -sv "https://aistudyarchitect.com/api/v1/content/search?q=test" -H "Authorization: Bearer $TOKEN" 2>&1
# Returns: HTTP 500, body: "Internal Server Error" (no detail exposed)
```
