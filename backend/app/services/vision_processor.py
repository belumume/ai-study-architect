...
class VisionProcessor:
    ...
    async def extract_with_claude(self, image_data: bytes, prompt: str | None = None) -> dict[str, Any]:
        """
...
[brief description of what the image contains]"""
    ...
    async def extract_with_openai(self, image_data: bytes, prompt: str | None = None) -> dict[str, Any]:
        """
