...
class InvalidCredentialsError(AuthenticationError):
    ...
    def __init__(self):
        super().__init__(
            detail="Incorrect username/email or password", error_code="INVALID_CREDENTIALS"
        )
...
class PermissionDeniedError(BaseAPIException):
    ...
    def __init__(self, detail: str = "Permission denied"):
        super().__init__(
            status_code=status.HTTP_403_FORBIDDEN, detail=detail, error_code="PERMISSION_DENIED"
        )
